...
@role('judge')
    ...
    @if(auth()->user()->hasPermissionTo('exam.scientific'))
        <li class="pc-item">
    ...
    {{-- الاختبار الشفهي --}}
    @if(auth()->user()->hasPermissionTo('exam.oral'))
        <li class="pc-item">
...
@if(auth()->user()->hasAnyRole(['admin', 'committee_supervisor', 'committee_control']))
...
{{-- ======= التقارير ======= --}}
@if(auth()->user()->hasAnyRole(['admin', 'committee_supervisor']))
<li class="pc-item">
